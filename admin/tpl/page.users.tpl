...
<div class="entry">
    ...
    <div class="pic pull-left">
        <img class="pull-left" src="{$settings.base_url}/content/avatar/{$key}.png?t={'' . CDIR . '/content/avatar/' . $key1 . '.' . 'png'|filemtime}" width=100>
        <a class="remove-pic btn btn-danger" href="remove_avatar/{$key}">x</a>
    </div>
    {else}
    <img class="pull-left" src="{$settings.base_url}/content/avatar/default.png" width=100>
    {/if}
    <div class="pull-left left-margin">
        <a href="{$admin}/user/{$key}"><b>{$value.displayname}</b></a><br />
